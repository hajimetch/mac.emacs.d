...
(use-package skk :no-require
  ...
  (set-variable 'skk-server-prog "/usr/local/bin/google-ime-skk") ; google-ime-skkの場所
  (set-variable 'skk-server-inhibit-startup-server nil) ; 辞書サーバを自動起動
  ...
  ;; 基本辞書
  (set-variable 'skk-large-jisyo "~/Dropbox/Emacs/ddskk/SKK-JISYO.L")

  ;; チュートリアルのパス
  (set-variable 'skk-tut-file "~/Dropbox/Emacs/ddskk/SKK.tut")
...
(use-package helm :no-require :ensure
  ...
  (set-variable 'helm-google-suggest-use-curl-p t) ; Google Suggest で curl を使用
...
(use-package elpy :ensure
  ...
  :config
  (defvar venv-default "~/opt/anaconda3/envs/py37")
...
(with-eval-after-load 'org
  ...
  (set-variable 'org-directory "~/Dropbox/Emacs/org/")
  (set-variable 'org-default-notes-file "~/Dropbox/Emacs/org/default.org")
  ...
  (set-variable 'org-refile-targets '(("~/Dropbox/Emacs/org/task.org" :maxlevel . 3)))
  (set-variable 'org-archive-location "~/Dropbox/Emacs/org/archive.org::datetree/")
  ...
  (setq org-capture-templates
        '(("t" "Task" entry
           (file+headline "~/Dropbox/Emacs/org/task.org" "Task")
           "* TODO %?\n%U" :empty-lines 1)
          ("T" "Task with Clipboard" entry
           (file+headline "~/Dropbox/Emacs/org/task.org" "Task")
           "* TODO %?\n%U\n%c" :empty-lines 1)
          ("n" "Note" entry
           (file+headline "~/Dropbox/Emacs/org/note.org" "Note")
           "* %?\n%U" :empty-lines 1)
          ("N" "Note with Clipboard" entry
           (file+headline "~/Dropbox/Emacs/org/note.org" "Note")
           "* %?\n%U\n%c" :empty-lines 1)
          ("m" "Memo" entry
           (file+headline "~/Dropbox/Emacs/org/note.org" "Memo")
           "* TODO %?" :empty-lines 0)
...
(use-package howm :demand :ensure
  ...
  :config
  (set-variable 'howm-directory "~/Dropbox/Emacs/howm/")
...
(set-variable 'ps-lpr-command "pdfpreview.sh")
