...
(use-package org
  ...
  (org-directory "~/Dropbox/Emacs/org/") ; デフォルトディレクトリ
  (org-default-notes-file "~/Dropbox/Emacs/org/default.org")
                                        ; デフォルトファイル名
  ...
  (org-refile-targets '(("~/Dropbox/Emacs/org/task.org" :maxlevel . 3)))
  (org-archive-location "~/Dropbox/Emacs/org/archive.org::datetree/")
